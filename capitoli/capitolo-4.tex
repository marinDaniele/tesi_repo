...
Vengono proposti il caso in cui la variabile \textit{quantita} sia maggiore di 0 e quello in cui la variabile sia 0 per mostrare il cambiamento nel template in base alla modifica dei dati.
\begin{figure}[htp]
	\centering
