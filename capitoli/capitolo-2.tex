...
Questa libreria offre anchessa la possibilità di creare template e interpolarli con dati di tipo JSON ma il suo funzionamento consiste in un approccio differente e l'insieme di strumenti offerti è di gran lunga superiore a quelli offerti dalle librerie studiate in precedenza.
La libreria è compatibile con tutti i brawsers e offre un'ottima compatibilità con SVG e lo standard ES15.\\
I template ottenuti con \textbf{Ractive.js} sono possono essere interattivi e offrono un \textit{binding} con il data model, quando i dati vengono modificati la libreria modifica in modo intelligente ed efficente il DOM del tempalte.
