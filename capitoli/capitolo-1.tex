...
\begin{itemize}
	...
	\item il lavoro di prototipazione relativo ai template, svolto inizialmente per confrontare le potenzialità delle librerie analizzate e in segiuto per la creazione dei template necessari per il progetto.
